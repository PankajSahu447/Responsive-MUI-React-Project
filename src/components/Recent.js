...
import { styled, useTheme, useMediaQuery, Stack, Typography } from "@mui/material";
...
const isMobile = useMediaQuery(theme.breakpoints.down("sm"))
  ...
  return (
    <Box>
            ...
            <Stack direction={ isMobile ? 'column' : 'row'} justifyContent={  'space-between'} boxSizing={'border-box'} px={4} width={'100%'}  height={'auto'} >
        <Typography variant="h6" fontWeight={'bolder'}>Recently Viewed</Typography>
        <Typography color={'blue'}>View all</Typography>
    </Stack>

 
    <Box sx={{ flexGrow: 1, mt: isMobile ? 6 :  10, px: 8 }}>
      <Grid container spacing={8.8}>
